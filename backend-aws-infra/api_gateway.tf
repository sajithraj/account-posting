...
# POST /v2/payment/account-posting → backend-aws (create posting)
resource "aws_apigatewayv2_route" "create_posting" {
  api_id    = aws_apigatewayv2_api.main.id
  route_key = "POST /v2/payment/account-posting"
...
resource "aws_apigatewayv2_route" "ops_search" {
  api_id    = aws_apigatewayv2_api.main.id
  route_key = "POST /v2/payment/account-posting/search"
...
resource "aws_apigatewayv2_route" "ops_retry" {
  api_id    = aws_apigatewayv2_api.main.id
  route_key = "POST /v2/payment/account-posting/retry"
  target    = "integrations/${aws_apigatewayv2_integration.ops_lambda.id}"
}
...
resource "aws_apigatewayv2_route" "ops_get_posting" {
  api_id    = aws_apigatewayv2_api.main.id
  route_key = "GET /v2/payment/account-posting/{id}"
  target    = "integrations/${aws_apigatewayv2_integration.ops_lambda.id}"
}
...
resource "aws_apigatewayv2_route" "ops_list_legs" {
  api_id    = aws_apigatewayv2_api.main.id
  route_key = "GET /v2/payment/account-posting/{id}/transaction"
  target    = "integrations/${aws_apigatewayv2_integration.ops_lambda.id}"
}
...
resource "aws_apigatewayv2_route" "ops_get_leg" {
  api_id    = aws_apigatewayv2_api.main.id
  route_key = "GET /v2/payment/account-posting/{id}/transaction/{order}"
  target    = "integrations/${aws_apigatewayv2_integration.ops_lambda.id}"
}
...
resource "aws_apigatewayv2_route" "ops_patch_leg" {
  api_id    = aws_apigatewayv2_api.main.id
  route_key = "PATCH /v2/payment/account-posting/{id}/transaction/{order}"
  target    = "integrations/${aws_apigatewayv2_integration.ops_lambda.id}"
}
...
resource "aws_apigatewayv2_route" "ops_list_config" {
  api_id    = aws_apigatewayv2_api.main.id
  route_key = "GET /v2/payment/account-posting/config"
  target    = "integrations/${aws_apigatewayv2_integration.ops_lambda.id}"
}
...
resource "aws_apigatewayv2_route" "ops_get_config_by_type" {
  api_id    = aws_apigatewayv2_api.main.id
  route_key = "GET /v2/payment/account-posting/config/{requestType}"
  target    = "integrations/${aws_apigatewayv2_integration.ops_lambda.id}"
}
...
resource "aws_apigatewayv2_route" "ops_create_config" {
  api_id    = aws_apigatewayv2_api.main.id
  route_key = "POST /v2/payment/account-posting/config"
  target    = "integrations/${aws_apigatewayv2_integration.ops_lambda.id}"
}
...
resource "aws_apigatewayv2_route" "ops_update_config" {
  api_id    = aws_apigatewayv2_api.main.id
  route_key = "PUT /v2/payment/account-posting/config/{type}/{order}"
  target    = "integrations/${aws_apigatewayv2_integration.ops_lambda.id}"
}
...
resource "aws_apigatewayv2_route" "ops_delete_config" {
  api_id    = aws_apigatewayv2_api.main.id
  route_key = "DELETE /v2/payment/account-posting/config/{type}/{order}"
  target    = "integrations/${aws_apigatewayv2_integration.ops_lambda.id}"
}
