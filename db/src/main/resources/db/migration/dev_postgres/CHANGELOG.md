# Migration Changelog — DEV (PostgreSQL)

Backup of the original dev PostgreSQL migrations before switching dev to Oracle syntax.
Scripts here represent the full consolidated history that was applied to dev PostgreSQL.
