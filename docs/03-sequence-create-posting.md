...
Detailed end-to-end sequence for `POST /account-posting`. Shows every participant from the inbound HTTP request through
strategy execution, leg updates, and optional Kafka publishing.
