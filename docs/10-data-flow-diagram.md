...
Shows how data transforms as it travels through the system — from inbound HTTP request through entity persistence, external system interaction, leg updates, response assembly, and MDC context propagation.
