...
Shows how exceptions are caught and translated, what happens when external systems fail, how duplicate submissions are handled, and how the retry lock expiry path works.
