      ...
      {popup && (
        <div style={overlay}>
          <div style={dialog}>
            ...
            <label style={labelStyle}>Reason <span style={{ color: '#888', fontWeight: 400 }}>(optional)</span></label>
            <textarea
...
const updateBtn: React.CSSProperties = { fontSize: 12, padding: '3px 10px', border: '1px solid #003b5c', borderRadius: 3, background: 'white', color: '#003b5c', cursor: 'pointer' };
const applyBtn: React.CSSProperties = { fontSize: 13, padding: '6px 18px', border: 'none', borderRadius: 4, background: '#003b5c', color: 'white', cursor: 'pointer', fontWeight: 500 };
const cancelBtn: React.CSSProperties = { fontSize: 13, padding: '6px 18px', border: '1px solid #c5cdd8', borderRadius: 4, background: 'white', color: '#444', cursor: 'pointer' };
const disabledStyle: React.CSSProperties = { opacity: 0.5, cursor: 'not-allowed' };
const overlay: React.CSSProperties = { position: 'fixed', inset: 0, background: 'rgba(0,0,0,0.35)', zIndex: 1000, display: 'flex', alignItems: 'center', justifyContent: 'center' };
const dialog: React.CSSProperties = { background: 'white', borderRadius: 8, padding: '24px 28px', width: 380, boxShadow: '0 8px 30px rgba(0,0,0,0.18)', display: 'flex', flexDirection: 'column' };
const labelStyle: React.CSSProperties = { fontSize: 12, fontWeight: 600, color: '#555', marginBottom: 5, display: 'block' };
const inputStyle: React.CSSProperties = { width: '100%', fontSize: 13, padding: '7px 10px', border: '1px solid #c5cdd8', borderRadius: 4, boxSizing: 'border-box', fontFamily: 'inherit', display: 'block' };
