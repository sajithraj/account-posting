...
export default function ConfigPage() {
    ...
    const updateMutation = useMutation({
        mutationFn: ({ requestType, orderSeq, req }) => postingApi.updateConfig(requestType, orderSeq, req),
        onSuccess: () => {
            queryClient.invalidateQueries({ queryKey: ['configs'] });
            closeForm();
        },
    ...
    const deleteMutation = useMutation({
        mutationFn: ({ requestType, orderSeq }) => postingApi.deleteConfig(requestType, orderSeq),
        onSuccess: () => {
            queryClient.invalidateQueries({ queryKey: ['configs'] });
    ...
    return (_jsxs("div", { style: s.page, children: [_jsxs("div", { style: s.header, children: [_jsx("h2", { style: s.title, children: "Posting Configuration" }), _jsx("button", { style: s.addBtn, onClick: openAdd, children: "+ ADD CONFIG" })] }), isLoading && _jsx("div", { style: s.statusMsg, children: "Loading..." }), isError && _jsx("div", { style: { ...s.statusMsg, color: '#c0392b' }, children: "Failed to load configs." }), data && (_jsxs("table", { style: s.table, children: [_jsx("thead", { children: _jsxs("tr", { style: s.theadRow, children: [_jsx("th", { style: s.th, children: "Request Type" }), _jsx("th", { style: s.th, children: "Order" }), _jsx("th", { style: s.th, children: "Source Name" }), _jsx("th", { style: s.th, children: "Target System" }), _jsx("th", { style: s.th, children: "Operation" }), _jsx("th", { style: s.th, children: "Processing Mode" }), _jsx("th", { style: { ...s.th, width: 110 }, children: "Actions" })] }) }), _jsx("tbody", { children: data.map(cfg => {
                            ...
                            return (_jsxs("tr", { style: s.tbodyRow, children: [_jsx("td", { style: s.td, children: cfg.requestType }), _jsx("td", { style: s.td, children: cfg.orderSeq }), _jsx("td", { style: s.td, children: cfg.sourceName }), _jsx("td", { style: s.td, children: cfg.targetSystem }), _jsx("td", { style: s.td, children: cfg.operation }), _jsx("td", { style: s.td, children: cfg.processingMode }), _jsxs("td", { style: s.td, children: [_jsx("button", { style: s.editBtn, onClick: () => openEdit(cfg), children: "Edit" }), isConfirming ? (_jsxs(_Fragment, { children: [_jsx("button", { style: s.confirmBtn, onClick: () => deleteMutation.mutate({ requestType: cfg.requestType, orderSeq: cfg.orderSeq }), disabled: deleteMutation.isPending, children: "Confirm" }), _jsx("button", { style: s.cancelBtn, onClick: () => setDeleteConfirm(null), children: "\u2715" })] })) : (_jsx("button", { style: s.deleteBtn, onClick: () => setDeleteConfirm({ requestType: cfg.requestType, orderSeq: cfg.orderSeq }), children: "Delete" }))] })] }, key));
                        }) })] })), showForm && (_jsx("div", { style: s.overlay, children: _jsxs("div", { style: s.modal, children: [_jsx("h3", { style: s.modalTitle, children: editing ? 'Edit Config' : 'Add Config' }), _jsxs("form", { onSubmit: handleSubmit, children: [[
