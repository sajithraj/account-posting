...
export default function PostingDetailPage() {
    ...
    const [updatingLegOrder, setUpdatingLegOrder] = useState(null);
    ...
    const updateLegMutation = useMutation({
        mutationFn: ({ transactionOrder, status, reason }) => postingApi.updateLegStatus(postingId, transactionOrder, status, reason),
        onSuccess: () => {
